...
|-------------------------------------------|----------------------------------------------------------------|------------|--------------|
| **Models & Database**                     |
| 1                                         | Define models: User, Group, Expense, Receipt                   | 1          |              |
...
| 10                                        | Implement services for User, Group, Expense, Receipt           | 4          |              |
...
| 23                                        | Polish UI/UX with Bootstrap and CSS or a framework             | 2          |              |
| **Stretch Goal (AWS S3)**                 |
